<%@ Page Language="C#" AutoEventWireup="true" Inherits="admin_login" CodeFile="login.aspx.cs" %>
        ...
        <div class="card card-login mx-auto mt-5">
            ...
            <div class="card-body">
                <form runat="server" id="formlogin">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="User login" CssClass="btn btn-primary btn-block"/>
