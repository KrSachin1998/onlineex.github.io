<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" Inherits="admin_question" CodeFile="question.aspx.cs" %>
                    ...
                    <asp:GridView ID="gridview_examquestion" runat="server" GridLines="None" CssClass="table table-bordered" AutoGenerateColumns="False" OnRowCommand="gridview_examquestion_RowCommand">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Options">
                                <ItemTemplate>
                                    <asp:HyperLink ID="btn_detailsexam" runat="server" CssClass="btn" BackColor="#343A40" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "~/admin/detailsexamquestion.aspx?eid=" + Eval("question_id") %>'>
